...
def interpolate_to_edge(U, X):
    '''
    Last dimension of U should have 5 elements. X is the evaluation point:
    X=3 for x_{i+1/2}.
    Returns estimates for U using the three-point left-, centre- and
    right-biased stencils.
    '''

    UL = 11*U[..., 0]/6 - 7*U[..., 1]/6 + U[..., 2]/3 - \
        2*X*U[..., 0] + 3*X*U[..., 1] - X*U[..., 2] + U[..., 0]*X*X/2 - \
        U[..., 1]*X*X + U[..., 2]*X*X/2
    UC = 13*U[..., 1]/3 - 31*U[..., 2]/6 + 11*U[..., 3]/6 - 3*U[..., 1]*X + \
        5*U[..., 2]*X - 2*U[..., 3]*X + U[..., 1]*X*X/2 - \
        U[..., 2]*X*X + U[..., 3]*X*X/2
    UR = 47*U[..., 2]/6 - 67*U[..., 3]/6 + 13*U[..., 4]/3 - 4*U[..., 2]*X + \
        7*U[..., 3]*X - 3*U[..., 4]*X + U[..., 2]*X*X/2 - \
        U[..., 3]*X*X + U[..., 4]*X*X/2
