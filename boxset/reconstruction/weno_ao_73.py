...
def interpolate_to_edge(U, X):
    ...
    X is the evaluation point: X=4 for x_{i+1/2}.
    Returns estimates for U using the three-point left-, centre- and
    right-biased stencils, as well as an estimate based on the 7-point
    centered stencil.
    '''
    ...
    ux = (-7843*U[..., 2] + 1688*U[..., 1] - 191*U[..., 0] + 7843*U[..., 4] -
          1688*U[..., 5] + 191*U[..., 6])/10080
    ux2 = (8385*U[..., 2] - 1014*U[..., 1] + 79*U[..., 0] - 14900*U[..., 3] +
           8385*U[..., 4] - 1014*U[..., 5] + 79*U[..., 6])/10080
    ux3 = (61*U[..., 2] - 38*U[..., 1] + 5*U[..., 0] - 61*U[..., 4] +
           38*U[..., 5] - 5*U[..., 6])/216
    ux4 = (-459*U[..., 2] + 144*U[..., 1] - 13*U[..., 0] + 656*U[..., 3] -
           459*U[..., 4] + 144*U[..., 5] - 13*U[..., 6])/1584
    ux5 = (-5*U[..., 2] + 4*U[..., 1] - U[..., 0] + 5*U[..., 4] -
           4*U[..., 5] + U[..., 6])/240
    ux6 = (15*U[..., 2] - 6*U[..., 1] + U[..., 0] - 20*U[..., 3] +
           15*U[..., 4] - 6*U[..., 5] + U[..., 6])/720

    P7 = U[..., 3] + ux*L1 + ux2*L2 + ux3*L3 + ux4*L4 + ux5*L5 + ux6*L6

    ux = (-82*U[..., 2] + 11*U[..., 1] + 82*U[..., 4] - 11*U[..., 5])/120
    ux2 = (40*U[..., 2] - 3*U[..., 1] - 74*U[..., 3] +
           40*U[..., 4] - 3*U[..., 5])/56
...
def smoothness_coefficients(U):
    ...
    Returns the smoothness coefficients for the left, centre and
    right-biased stencils, as well as the smoothness coefficient for
    the 5-point centered stencil.
    '''
    betaL = 13*(U[..., 1] - 2*U[..., 2] + U[..., 3])**2/12 + \
        0.25*(U[..., 1] - 4*U[..., 2] + 3*U[..., 3])**2
    betaC = 13*(U[..., 2] - 2*U[..., 3] + U[..., 4])**2/12 + \
        0.25*(U[..., 2] - U[..., 4])**2
    betaR = 13*(U[..., 3] - 2*U[..., 4] + U[..., 5])**2/12 + \
        0.25*(3*U[..., 3] - 4*U[..., 4] + U[..., 5])**2
    ...
    beta7 = (ux + ux3/10 + ux5/126)**2 + \
        13*(ux2 + 123*ux4/455 + 85*ux6/2002)**2/3 + \
        781*(ux3 + 26045*ux5/49203)**2/20 + \
        1421461*(ux4 + 81596225*ux6/93816426)**2/2275 + \
        21520059541*ux5**2/1377684 + \
        15510384942580921*ux6**2/27582029244
    ...
    beta5 = (ux + ux3/10)**2 + 13*(ux2 + 123*ux4/455)**2/3 + \
        781*ux3**2/20 + 1421461*ux4**2/2275
...
def nonlinear_weights(U, epsilon):
    ...
    tau7 = (np.abs(beta7 - betaR) +
            np.abs(beta7 - betaC) +
            np.abs(beta7 - betaL))/3
    ...
    tau5 = (np.abs(beta5 - betaR) +
            np.abs(beta5 - betaC) +
            np.abs(beta5 - betaL))/3
    ...
    return wL5*norm_fac5, wC5*norm_fac5, wR5*norm_fac5, w5*norm_fac5, \
        wL7*norm_fac7, wC7*norm_fac7, wR7*norm_fac7, w7*norm_fac7, \
        nu53*norm_fac_nu, nu73*norm_fac_nu
...
def calc_interface_flux(U, X, epsilon=1.0e-12):
    ...
    wL5, wC5, wR5, w5, wL7, wC7, wR7, w7, nu53, nu73 = \
        nonlinear_weights(U, epsilon)

    # Return final approximation
    P73 = wL7*uL + wC7*uC + wR7*uR + \
        w7*(u7 - gamma1_3*uL - gamma2_3*uC - gamma3_3*uR)/gamma3_7
    P53 = wL5*uL + wC5*uC + wR5*uR + \
        w5*(u5 - gamma1_3*uL - gamma2_3*uC - gamma3_3*uR)/gamma3_7
